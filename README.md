...
「ターミナルとエディタ」「AIを複数体動かす」の2本立て。全27枚。
...
|---|---|---|
| 1〜4 | はじめに | 5分 |
| 5〜13 | 第1章 開発の道具は3つに分かれる | 22分 |
| 14〜26 | 第2章 AIを複数体動かす | 31分 |
| 27 | 今日から試す3つ | 2分 |
...
**0:38 で19枚目に着いていなければ第1章が伸びている。**
第2章Aを巻いて、本題のBに時間を残す。

「うまくいかないときは3か所を確認する」（同じファイルを直した／
UIとAPIの形が違った／レビューを早く始めた）は口頭へ下げた。
トラブルシュートは投影しなくても伝わるため。
